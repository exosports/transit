...
#define GGRAV (6.67430e-8)       /* Gravitational constant (erg * cm / g^2)  */
#define HOUR (3600.0)            /* 1 hour (s)                               */
#define AU (14959787070000.000)  /* 1 Astronomical unit (cm)                 */
#define ANGSTROM (1e-8)          /* 1 Angstrom (cm)                          */
#define SUNMASS (1.9891e33)      /* Solar mass (g)                           */
#define SUNRADIUS (6.957e10)     /* solar volumetric mean radius (cm)        */
#define AMU (1.6605390666e-24)   /* Atomic Mass unit (g)                     */
...
#define ME (9.1093837015e-28)    /* Electron mass (g)                        */
#define KB (1.380649e-16)        /* Boltzmann constant (erg / K)             */
#define H (6.62607015e-27)       /* Planck's constant (erg * s)              */
