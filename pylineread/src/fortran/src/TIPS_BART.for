...
C  Enter Isotopologue:
   25  CALL BART_ISO_82_TO_85 (MOL,NSO82,ISO)
C  Enter Temperature: [70 - 3000] K'
   30  READ (*,*) Temp
...
C
   ...
   10 CONTINUE
      ...
      include 'BD_MOL_2011.for'
      include 'BD_ISO_2011.for'
      include 'BART_BD_ISO_82_TO_85.for'
